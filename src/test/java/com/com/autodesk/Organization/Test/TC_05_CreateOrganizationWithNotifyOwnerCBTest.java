...
public class TC_05_CreateOrganizationWithNotifyOwnerCBTest extends BaseClass {
	@Test
	public void createOrganizationWithNotifyOwnerCBTest() throws Throwable {
		...
		cop.createOrganizationWithNotify
		(OrgName+ju.getRandomNum());
